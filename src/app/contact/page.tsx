...
import { submitWorshipRequest } from "@/app/actions/worship-requests";
    ...
    return (
      <>
        <section className="relative pt-32 pb-20 bg-deep-black">
          <div className="absolute inset-0 opacity-20" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=1920&q=80')", backgroundSize: "cover", backgroundPosition: "center" }} />
          <div className="absolute inset-0 bg-gradient-to-b from-deep-black/70 to-deep-black" />
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
            <p className="text-gold tracking-[0.3em] uppercase text-sm font-medium mb-4">Request Worship</p>
            <h1 className="font-[family-name:var(--font-display)] text-4xl md:text-5xl text-white mb-4">Submit Your Proclaiming Praise Request</h1>
          </div>
        </section>
          ...
          <div className="max-w-2xl mx-auto px-6 text-center">
            <div className="bg-white rounded-3xl shadow-sm p-12">
              ...
              <p className="text-charcoal/60 leading-relaxed">
                Thank you for reaching out. Tyler & Sabrina will review your
                request and be in touch soon. You are loved and prayed for.
              </p>
            </div>
          </div>
        </section>
          ...
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-3">
                <div>
                  <label className="block text-xs text-charcoal/50 mb-1">Month</label>
                  <select
                    name="event_month"
                    className="w-full px-3 py-3 bg-warm-white border border-warm-gray rounded-xl focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-colors text-charcoal/70 text-sm"
                  >
                    <option value="">--</option>
                ...
                <div>
                  <label className="block text-xs text-charcoal/50 mb-1">Day</label>
                  <input
                    type="number"
                    name="event_day"
                    min={1}
                ...
                <div>
                  <label className="block text-xs text-charcoal/50 mb-1">Year</label>
                  <input
                    type="number"
                    name="event_year"
                    min={2026}
                ...
                <div>
                  <label className="block text-xs text-charcoal/50 mb-1">Time</label>
                  <input
                    type="time"
                    name="event_time"
                    className="w-full px-3 py-3 bg-warm-white border border-warm-gray rounded-xl focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-colors text-sm"
